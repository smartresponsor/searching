...
final readonly class DoctrineSearchRelevanceProfileWriter implements SearchRelevanceProfileWriterInterface
{
    ...
    public function create(array $payload): SearchRelevanceProfileEntity
    {
        $profile = SearchRelevanceProfileEntity::create(
            name: $this->requiredString($payload, 'nameEntity'),
    ...
    {
        $profile->update(
            name: $this->requiredString($payload, 'nameEntity', $profile->getName()),
